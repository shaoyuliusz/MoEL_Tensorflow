"""
<<<<<<< HEAD
This code is adopted from the original code in MoEL paper defining default parameters
=======
This code is adopted from the original code in MoEL paper and adjusted by the new settings used
